...
def test_attacks_not_blocked(s: TestServer):
...
def test_rate_limiting_not_enforced(s: TestServer):
...
def test_blocked_users_not_blocked(s: TestServer):
...
def test_no_heartbeat_or_start_events(c: CoreApi, initial_heartbeat_events):
...
def run_test(s: TestServer, c: CoreApi):
    ...
    test_attacks_not_blocked(s)
    test_rate_limiting_not_enforced(s)
    test_blocked_users_not_blocked(s)
    test_no_heartbeat_or_start_events(c, initial_heartbeat_events)
