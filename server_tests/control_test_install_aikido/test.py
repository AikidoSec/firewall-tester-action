...
2. Send 100 requests and 8 attacks - blocked
3. Stop server, uninstall aikido, start server
4. Send 100 requests and 8 attacks - not blocked
5. Install aikido, send 8 attacks - not blocked
6. Restart server, send 8 attacks - blocked
"""
