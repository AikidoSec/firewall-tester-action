...
2. Restart the server using stop start and send 100 requests and 100 attacks
3. Restart the server using stop start and send 100 attacks and 100 requests
...
def restart_server_using_stop_start():
    cs.stop_server()
